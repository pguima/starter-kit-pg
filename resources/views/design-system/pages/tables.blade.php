                ...
                <div class="mt-4">
                    <x-ds::table :headers="[
                        ...
                        @foreach([
                            ...
                            <tr class="border-b border-[var(--border-subtle)] transition-colors hover:bg-[var(--surface-hover)]">
                                <x-ds::table-cell variant="bold">
                                    <div class="flex items-center gap-3">
                                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-[var(--surface-hover)] text-xs font-bold text-[var(--text-secondary)]">
                ...
                <div class="mt-4">
                    <x-ds::table :headers="['Project', 'Progress', 'Team', 'Due Date', 'Actions']">
                        ...
                        <tr class="border-b border-[var(--border-subtle)] hover:bg-[var(--surface-hover)]">
                            <x-ds::table-cell>
                                <div class="flex items-center gap-3">
                                    <span class="flex h-8 w-8 items-center justify-center rounded bg-[var(--tag-purple)] text-[var(--tag-purple-text)]">
                                        <iconify-icon icon="solar:figma-linear" class="text-lg"></iconify-icon>
                                    </span>
                                    <span class="font-medium text-[var(--text-primary)]">Website Redesign</span>
                                </div>
                            </x-ds::table-cell>
                            <x-ds::table-cell>
                                <div class="w-32">
                                    ...
                                    <div class="h-1.5 w-full overflow-hidden rounded-full bg-[var(--surface-hover)]">
                                        <div class="h-full rounded-full bg-[var(--color-primary)]" style="width: 75%"></div>
                                    </div>
                                </div>
                            </x-ds::table-cell>
                            <x-ds::table-cell>
                                <div class="flex -space-x-2">
                                    <img class="h-7 w-7 rounded-full border-2 border-[var(--surface-card)]" src="https://ui-avatars.com/api/?name=A+B&background=random" alt="">
                                    <img class="h-7 w-7 rounded-full border-2 border-[var(--surface-card)]" src="https://ui-avatars.com/api/?name=C+D&background=random" alt="">
                                    <span class="flex h-7 w-7 items-center justify-center rounded-full border-2 border-[var(--surface-card)] bg-[var(--surface-hover)] text-xs text-[var(--text-secondary)]">+3</span>
                                </div>
                            </x-ds::table-cell>
                            ...
                            <x-ds::table-cell>
                                <div class="flex items-center gap-2">
                                    ...
                                    <x-ds::button variant="ghost" size="icon" icon="solar:trash-bin-trash-linear" class="text-[var(--status-error)] hover:bg-[var(--status-error-light)]"></x-ds::button>
                                </div>
                            </x-ds::table-cell>
                        </tr>
                        ...
                        <tr class="border-b border-[var(--border-subtle)] hover:bg-[var(--surface-hover)]">
                            <x-ds::table-cell>
                                <div class="flex items-center gap-3">
                                    <span class="flex h-8 w-8 items-center justify-center rounded bg-[var(--tag-blue)] text-[var(--tag-blue-text)]">
                                        <iconify-icon icon="solar:code-circle-linear" class="text-lg"></iconify-icon>
                                    </span>
                                    <span class="font-medium text-[var(--text-primary)]">Mobile App</span>
                                </div>
                            </x-ds::table-cell>
                            <x-ds::table-cell>
                                <div class="w-32">
                                    ...
                                    <div class="h-1.5 w-full overflow-hidden rounded-full bg-[var(--surface-hover)]">
                                        <div class="h-full rounded-full bg-[var(--status-info)]" style="width: 45%"></div>
                                    </div>
                                </div>
                            </x-ds::table-cell>
                            <x-ds::table-cell>
                                <div class="flex -space-x-2">
                                    <img class="h-7 w-7 rounded-full border-2 border-[var(--surface-card)]" src="https://ui-avatars.com/api/?name=E+F&background=random" alt="">
                                </div>
                            </x-ds::table-cell>
                        ...
                        <tr class="border-b border-[var(--border-subtle)] hover:bg-[var(--surface-hover)]">
                            <x-ds::table-cell>
                                <div class="flex items-center gap-3">
                                    <span class="flex h-8 w-8 items-center justify-center rounded bg-[var(--tag-green)] text-[var(--tag-green-text)]">
                                        <iconify-icon icon="solar:chart-square-linear" class="text-lg"></iconify-icon>
                                    </span>
                                    <span class="font-medium text-[var(--text-primary)]">Marketing Campaign</span>
                                </div>
                            </x-ds::table-cell>
                            <x-ds::table-cell>
                                <div class="w-32">
                                    ...
                                    <div class="h-1.5 w-full overflow-hidden rounded-full bg-[var(--surface-hover)]">
                                        <div class="h-full rounded-full bg-[var(--status-success)]" style="width: 100%"></div>
                                    </div>
                                </div>
                            </x-ds::table-cell>
                            <x-ds::table-cell>
                                <div class="flex -space-x-2">
                                    <img class="h-7 w-7 rounded-full border-2 border-[var(--surface-card)]" src="https://ui-avatars.com/api/?name=G+H&background=random" alt="">
                                    <img class="h-7 w-7 rounded-full border-2 border-[var(--surface-card)]" src="https://ui-avatars.com/api/?name=I+J&background=random" alt="">
                                </div>
                            </x-ds::table-cell>
                 ...
                 <div class="mt-4">
                    <x-ds::table :headers="['Invoice', 'Client', 'Amount', 'Status']" :checkbox="true">
                        @foreach([
                            ...
                            <tr class="border-b border-[var(--border-subtle)] hover:bg-[var(--surface-hover)] group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <input type="checkbox" class="h-4 w-4 rounded border-[var(--border-default)] bg-[var(--surface-card)] text-[var(--color-primary)] focus:ring-[var(--color-primary)]/20">
                                    </div>
                                </td>
                                <x-ds::table-cell>
                                    <span class="font-mono font-medium text-[var(--text-primary)]">{{ $inv['id'] }}</span>
                                </x-ds::table-cell>
                         ...
                         <x-slot:footer>
                            <div class="flex items-center justify-between">
                                <div class="text-sm text-[var(--text-muted)]">
                                    Showing <span class="font-medium text-[var(--text-primary)]">1</span> to <span class="font-medium text-[var(--text-primary)]">3</span> of <span class="font-medium text-[var(--text-primary)]">12</span> results
                                </div>
                    ...
                    <x-ds::table :headers="['Task', 'Assignee', 'Status', 'Due Date']">
                        ...
                        <x-slot:footer>
                             <div class="flex flex-col items-center justify-center py-12 text-center">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--surface-hover)]">
                                    <iconify-icon icon="solar:clipboard-remove-linear" class="text-2xl text-[var(--text-muted)]"></iconify-icon>
                                </div>
                                <h3 class="mt-3 text-sm font-semibold text-[var(--text-primary)]">No tasks found</h3>
                                <p class="mt-1 text-sm text-[var(--text-secondary)]">Get started by creating a new task.</p>
                                <div class="mt-4">
            ...
            <div class="mt-12">
                ...
                <x-ds::card class="h-full" :title="__('ds.pages.tables.docs.usage_title')" :description="__('ds.pages.tables.docs.usage_subtitle')">
                    <div class="mt-4 grid grid-cols-1 gap-6">
                        <div>
                             <div class="text-sm font-semibold text-[var(--text-primary)]">{{ __('ds.pages.tables.docs.example_code_title') }}</div>
...
@endverbatim</code></pre>
                        ...
                        <div>
                            <div class="text-sm font-semibold text-[var(--text-primary)]">{{ __('ds.pages.tables.docs.props_title') }}</div>
                            <div class="mt-3 grid grid-cols-1 gap-4 text-sm text-[var(--text-secondary)] sm:grid-cols-2">
                                <div><span class="font-semibold text-[var(--text-primary)]">headers</span> — Array of column titles.</div>
                                <div><span class="font-semibold text-[var(--text-primary)]">striped</span> — Alternate row background color.</div>
                                <div><span class="font-semibold text-[var(--text-primary)]">hoverable</span> — Highlight row on hover.</div>
                                <div><span class="font-semibold text-[var(--text-primary)]">bordered</span> — Add borders to cells.</div>
                                <div><span class="font-semibold text-[var(--text-primary)]">checkbox</span> — Add a select-all checkbox.</div>
                                <div><span class="font-semibold text-[var(--text-primary)]">compact</span> — reduce padding.</div>
                            </div>
                        </div>
                    </div>
                </x-ds::card>
